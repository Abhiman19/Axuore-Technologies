        ...
        <div className="grid lg:grid-cols-2 items-center mb-16">
          <div className="space-y-6">
            <p className="text-lg text-gray-200">
              ...
              solutions and impactful digital marketing services. Our expert
              team is dedicated to helping businesses streamline operations,
              enhance their online presence, and achieve sustainable growth.
            </p>
            <p className="text-lg text-gray-200">
